(() => {
  ...
  function renderSettings(root){root.innerHTML='<div class="page"><div class="page-head"><div><span class="eyebrow">PREFERENCES</span><h1>Settings</h1><p>Opening workspace…</p></div></div><div class="card pad"><div class="muted" style="font-size:9px">Loading settings workspace…</div></div></div>';window.__ORBIT_USER=S.user||window.__ORBIT_USER||{};requestAnimationFrame(()=>window.__ORBIT_ENHANCE_SETTINGS?.())}
